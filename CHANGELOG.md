...
## [1.2.0] 2026-09-09
### Added
- Global configuration of cache retention. You can find the file configuration in persistent directory (where Player.log is stored).
- LethalConfig support.

## [1.1.0] 2026-08-19
### Changed
- Cache retention was changed to 7 days.
